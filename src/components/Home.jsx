  ...
  return (
    <div name="home" className='w-full h-screen bg-[#0a192f]'>
      ...
      <div className='max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full'>
        <p className='text-[#75e44f]'>Hi, my name is</p>
        ...
        <li>
          <Link to='about' smooth={true} duration={500} className='text-white group w-40 hover:w-[162px] border-2 px-6 py-3 my-2 flex items-center hover:bg-[#75e44f] hover:border-[#75e44f] hover:font-bold'>
            View Work
